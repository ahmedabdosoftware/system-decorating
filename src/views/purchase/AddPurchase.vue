                ...
                <div>
                  ...
                  >
                    ...
                    <datalist id="propList">
                      <option
                        v-for="product in ProductsInBranch"
                        :key="product.id"
                        :value="product.name"
                      ></option>
                    </datalist>
              ...
              <div class="formbold-input-flex">
                ...
                <div>
                  ...
                  >
                    ...
                    <select
                      class="formbold-form-input-no-right-padding"
                      v-model="kindDiscount"
                    >
  ...
  methods: {
    ...
    async changeProductsInSystem() {
      for (const product of this.addedPurchase) {
        const existingProduct = this.myAllProducts.find(
          (p) => p.id === product.id
        );
