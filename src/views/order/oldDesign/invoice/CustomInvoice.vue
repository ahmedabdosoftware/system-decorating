          ...
          <ValidationObserver ref="observer" v-slot="{ invalid }">
            <form @submit.prevent="handelUpdateOrder">
              ...
              <div class="formbold-input-flex">
                <div>
                  <label
                    for="ampuntOfIncrease"
                    class="formbold-form-label aline-end"
                  >
                    مقدار الزيادة او النقصان</label
                  >
                  <input
                    type="number"
                    id="ampuntOfIncrease"
              ...
              <div class="formbold-input-flex">
                ...
                <div>
                  <label
                    for="editOfInstallation"
                    class="formbold-form-label aline-end"
                  >
                    تعديل المصنعية</label
                  >
                  <input
                    type="number"
              ...
              <div class="formbold-mb-3 cont_add_del_upda">
                <button
                  ...
                  :disabled="
                    !selectedProduct ||
                    (editOfInstallation <= 0 && amountOfIncrease == 0)
                  "
              ...
              <div v-if="displayInstallation" class="formbold-input-flex">
                ...
                <div>
                  <label
                    for="fixedInstallation"
                    class="formbold-form-label aline-end"
                  >
                    سعر مصنعية موحد ؟</label
                  >
                  <input
                    type="number"
    ...
    editProduct() {
      ...
      if (index !== -1) {
        if (Number(this.amountOfIncrease) !== 0) {
          console.log("inside");
          var spichialPrice =
            this.productInfo.priceMaterial + parseFloat(this.amountOfIncrease);
        ...
        console.log(
          "spichialPrice",
          spichialPrice,
          "this.productInfo.priceMaterial",
          this.productInfo.priceMaterial,
          "this.amountOfIncrease",
          this.amountOfIncrease,
          "editOfInstallation",
          this.editOfInstallation
        );
