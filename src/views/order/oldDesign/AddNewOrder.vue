          ...
          <ValidationObserver ref="observer" v-slot="{ invalid }">
            <form @submit.prevent="creatNewOrder">
              <div class="formbold-input-flex">
                <div>
                  <label for="customer" class="formbold-form-label"
                    >اختر العميل</label
                  >
                  <input
                    list="customerList"
                ...
                <div>
                  <label for="technical" class="formbold-form-label">
                    :اختر الفنى
                  </label>
                  <input
                    list="technicalList"
              ...
              <div class="formbold-input-flex">
                <div>
                  <label for="shipping" class="formbold-form-label">
                    الشحن
                  </label>
                  <input
                    type="number"
              ...
              <div class="formbold-input-flex">
                <div>
                  <ValidationProvider
                    ...
                    v-slot="{ errors }"
                  >
                    <label for="quantity" class="formbold-form-label">
                      الكمية
                    </label>
                ...
                <div>
                  <label for="product" class="formbold-form-label">
                    المنتج
                  </label>
                  <ValidationProvider
                    name="المنتج"
              ...
              <div class="formbold-input-flex">
                ...
                <div>
                  <label for="priceOffer" class="formbold-form-label">
                    الخصم
                  </label>
                  <input
                    type="number"
              ...
              <div class="formbold-input-flex">
                <div>
                  <ValidationProvider
                    ...
                    v-slot="{ errors }"
                  >
                    <label for="numberOfOrders" class="formbold-form-label">
                      رقم الطلب
                    </label>
                    <input
                      type="number"
                ...
                <div>
                  <label for="laborPrice" class="formbold-form-label"
                    >حدد المصنعية يدويا
                  </label>
                  <input
                    type="number"
...
export default {
  ...
  methods: {
    ...
    getProductFromBranch() {
      ...
      const product = getBranch.products.find(
        (product) => product.id === this.productId
      );
    ...
    async creatNewOrder() {
      ...
      try {
        ...
        if (this.customInvoice) {
          ...
          this.$router.push({
            name: "CustomInvoice",
            params: { orderId: orderId, isCustom: "true" },
          });
        } else {
          sweetalert(
            "تم إنشاء الطلب بنجاح!",
          ...
          this.$router.push({
            name: "Fatora",
            params: { orderId: orderId, isCustom: "false" },
          });
        }
      } catch (error) {
