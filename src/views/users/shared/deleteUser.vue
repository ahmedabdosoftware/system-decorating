  ...
  <div class="add">
    <div class="add_title">
      <p :class="{ 'dark-mode-title': getDarkMode }">
        Delete {{ role == "clint" ? "Clint" : "technical" }}
      </p>
    </div>
    <div
      :class="{ 'dark-moode': getDarkMode }"
      class="add_allContent add_allContent--edit"
    >
      <div>
        <h3
          v-if="shouldShowText"
        ...
        >
          <small class="moreSmall"
            >please inter email and password for deleting</small
          >
        </h3>
      ...
      >
        <form
          ...
          class="add_allContent_cont-form add_allContent_cont-form--edit"
        >
