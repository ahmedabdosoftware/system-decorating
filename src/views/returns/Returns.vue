<template>
    ...
    <div class="Purchases">
      <div class="title">
        <div>
          <div class="contTitle">
            ...
            <p :class="{ 'dark-mode-title': getDarkMode }">Returns grid</p>
          </div>
          <div>
            <div class="export">
              <img
      ...
      <div :class="{ 'dark-mode-box': getDarkMode }" class="allContent">
        ...
        <ListTable v-else-if="getReturns.length > 0" :returns="getReturns"  class="ListTable_cont"></ListTable>
        <NoData v-else  context="returns"></NoData>
  ...
  // ListTable
  import ListTable from "@/components/returns/ListTable.vue";
  ...
  export default {
    ...
    getReturns() {
            ...
            if(this.purchaseId){
            // if we came to this page from list of purchase page to see related returns
             filteredReturns = this.returns.filter(
                    ret => ret.purchaseId == this.purchaseId
              );;
            }
            ...
            if (this.selectStatus !== 'all') {
                filteredReturns = filteredReturns.filter(
                    ret => ret.status == this.selectStatus
              );
            }
          ...
          if (this.searchQuery) {
            filteredReturns = filteredReturns.filter(ret => {
              const valueToSearch = ret[this.selectedFilter].toString().toLowerCase();
              console.log(ret[this.selectedFilter].toString().toLowerCase())
