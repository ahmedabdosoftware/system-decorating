              ...
              <div class="formbold-input-flex">
                <div>
                  <ValidationProvider
                    ...
                    v-slot="{ errors }"
                  >
                    <label for="quantityReturn" class="formbold-form-label">
                    ...
                    <p class="info-message">
                      <span class="bold"> {{ quantity ? quantity : 0 }}</span> :
                      الكميه الاصليه
                    </p>
    ...
    async createNewReturn() {
      ...
      try {
        if (this.addedPurchase.length === 0) {
          sweetalert(
            "لا يمكن إنشاء المرتجع بدون منتجات.",
            "يرجى إضافة منتجات قبل إنشاء المرتجع.",
            "error"
          );
