      ...
      <div class="formbold-main-wrapper">
        <div class="formbold-form-wrapper">
          ...
          <ValidationObserver ref="observer" v-slot="{ invalid }">
            <form @submit.prevent="creatNewBranch">
              <div class="formbold-input-flex">
                ...
                <div>
                  <label for="nameBranch" class="formbold-form-label">
                    اسم المخزن
                  </label>
                  <input
                    type="text"
              ...
              <div class="formbold-input-flex">
                ...
                <div>
                  ...
                  >
                    <option
                      v-for="product in addedInBranch"
                      :value="product.id"
                      :key="product.id"
                    >
                      {{ product.name }}
              ...
              <div class="formbold-input-flex">
                ...
                <div>
                  ...
                  <ValidationProvider
                    name="المنتج"
                    :rules="`${addedInBranch.length == 0 ? 'required' : ''}`"
                    v-slot="{ errors }"
                  >
                    <input
                      list="propList"
              ...
              <div class="formbold-input-flex">
                ...
                <div>
                  <ValidationProvider
                    ...
                    v-slot="{ errors }"
                  >
                    <label for="alert" class="formbold-form-label">
                      التنبيه</label
                    >
...
export default {
  ...
  methods: {
    ...
    ...mapActions(useBranchesStore, ["addBranch"]),
    ...
    selectProductForUpdate() {
      const selectedUpdatePro = this.addedInBranch.find(
    ...
    updateProduct() {
      const index = this.addedInBranch.findIndex(
    ...
    async creatNewBranch() {
      this.isLoading = true;

      try {
        if (this.addedInBranch.length === 0) {
          sweetalert(
            "لا يمكن إنشاء الفرع بدون منتجات.",
            "يرجى إضافة منتجات قبل إنشاء الفرع.",
            "error"
          );
