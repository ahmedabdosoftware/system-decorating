      ...
      <div :class="{ 'dark-mode-box': getDarkMode }" class="allContent">
        <div class="detailsContent">
          ...
          <div class="detailsContent__transactionInfo">
            ...
            <div v-if="isClientTransaction" class="detailsContent__transactionInfo__general">
            ...
            <div v-if="isTechnicalTransaction && transactionInfo.DailyIndustrial" class="detailsContent__transactionInfo__general">    
              <p>عدد الأيام: {{ transactionInfo.numberOfDayes }}</p>
              <p>عدد الأيام المدفوعة: {{ transactionInfo.numberOfDayesPaid || 0 }}</p>
            </div>
            <div v-if="isTechnicalTransaction && transactionInfo.amount" class="detailsContent__transactionInfo__general">    
              <p>المستحق: {{ transactionInfo.amount }}</p>
              <p>الباقي: {{ remainingAmount }}</p>
            </div>
            <div v-if="isTechnicalTransaction && transactionInfo.DailyAssistantIndustrial" class="detailsContent__transactionInfo__general">
          ...
          <div v-if="transactionInfo.payments.length > 0" class="detailsContent__listTransactions">
            <div>
              <p>:الدفعات</p>
            </div>
            <div>
