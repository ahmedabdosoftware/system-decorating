<template>
  ...
  <div class="page transactions">
    <div class="title--pagesInProfile">
      <div>
        <div class="random-cont"></div>
        <div>
          <div class="export"></div>
          <router-link v-if="isAdmin" :to="generateRoute('AddFinancial')">
    ...
    <div :class="{ 'dark-mode-box': getDarkMode }" class="allContent">
      ...
      <ListTable
        v-else-if="getTransactions.length > 0"
...
export default {
  ...
  computed: {
    ...
    getTransactions() {
      let filteredTransactions = this.specificUserTransactions;
      ...
      if (this.searchQuery) {
        filteredTransactions = filteredTransactions.filter((transaction) => {
          const valueToSearch = transaction[this.selectedFilter]
            .toString()
            .toLowerCase();
  ...
  async created() {
    ...
    console.log("specificUserTransactions", this.specificUserTransactions);
    console.log("getTransactions", this.getTransactions);
  },
  methods: {
