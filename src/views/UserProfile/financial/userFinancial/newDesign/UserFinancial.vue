<template>
  ...
  // componnents
import OptionWraper from "@/components/users/financial/mainPage/optionTransaction/OptionWraper.vue";
import GlobalInfoWraper from "@/components/users/financial/mainPage/globalInfo/GlobalInfoWraper.vue";
