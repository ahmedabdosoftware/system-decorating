      ...
      <div class="links">
        ...
        <div :class="{ 'dark-mode-content': getDarkMode }">
          <router-link to="/dashboard">
            <img
              class="iconAwesome"
              :src="require('@/assets/icons/homepage.png')"
            />
            <!-- <font-awesome-icon class="iconAwesome" icon="house" /> -->
          </router-link>
        ...
        <div
          ...
          :class="[
            {
              'different-color': isProductsOpen,
        ...
        >
          ...
          <img
            class="iconAwesome"
            :src="require('@/assets/icons/products.png')"
          />
          <p class="link products_p">products</p>
          <font-awesome-icon
            v-if="!isCollapsed"
            class="arrow"
            :icon="isProductsOpen ? 'chevron-up' : 'chevron-down'"
          />

          <!--slot -->
          <DropDownMenuSidebar position="products" v-show="isCollapsed">
            <router-link to="/dashboard/Product"> products </router-link>
            <router-link to="/dashboard/AddNewProduct">
              add products
            </router-link>
            <router-link to="/dashboard/units"> units </router-link>
            <router-link to="/dashboard/notes"> ads poster </router-link>
        ...
        <div
          v-show="isProductsOpen && !isCollapsed"
          :class="[
            {
              'different-color': isProductsOpen,
              'dark-mode-content': getDarkMode,
        ...
        <div :class="{ 'dark-mode-content': getDarkMode }">
          ...
          <router-link
            v-if="!isCollapsed"
            to="/dashboard/users/technicalPages/Technical"
          >
        ...
        <div :class="{ 'dark-mode-content': getDarkMode }">
          ...
          <router-link
            v-if="!isCollapsed"
            to="/dashboard/users/clintPages/Clint"
          >
        ...
        <div :class="{ 'dark-mode-content': getDarkMode }" class="projects">
          <router-link to="/dashboard/Projects">
            ...
            <img
              class="iconAwesome"
              :src="require('@/assets/icons/practice_2.png')"
            />
          </router-link>
        ...
        <!-- Storage Section -->
        <div
          @click="toggleSubMenu('storage')"
          :class="[
            {
              'different-color': isStorageOpen,
              'dark-mode-content': getDarkMode,
            },
            'storage-sup',
          ]"
        >
          ...
          <img
            class="iconAwesome"
            :src="require('@/assets/icons/warehouse.png')"
          />
          <p class="link storage_p">storage</p>
          <font-awesome-icon
            v-if="!isCollapsed"
            class="arrow"
            :icon="isStorageOpen ? 'chevron-up' : 'chevron-down'"
          />
          ...
          >
            <router-link to="/dashboard/Branches"> storage </router-link>
            <router-link to="/dashboard/AddNewBranch">
              add storage
            </router-link>
            <router-link to="/dashboard/StockAlerts"> alert stock </router-link>
            <router-link to="/dashboard/Transfer"> transfer </router-link>
        ...
        <div
          v-show="isStorageOpen && !isCollapsed"
          :class="[
            {
              'different-color': isStorageOpen,
              'dark-mode-content': getDarkMode,
        ...
        <div
          ...
          :class="[
            {
              'different-color': isPurchasesOpen,
              'dark-mode-content': getDarkMode,
            },
            'purchase-sup',
          ]"
        >
          ...
          <img
            class="iconAwesome"
            :src="require('@/assets/icons/Purchases.png')"
          />
          <p class="link purchases_p">Purchases</p>
          <font-awesome-icon
            v-if="!isCollapsed"
            class="arrow"
            :icon="isPurchasesOpen ? 'chevron-up' : 'chevron-down'"
          />
          ...
          <DropDownMenuSidebar position="purchases" v-show="isCollapsed">
            ...
            <router-link to="/dashboard/Returns"> returns </router-link>
          </DropDownMenuSidebar>
        </div>

        <div
          v-show="isPurchasesOpen && !isCollapsed"
          :class="[
            {
              'different-color': isPurchasesOpen,
              'dark-mode-content': getDarkMode,
  ...
  methods: {
    ...
    toggleSidebar() {
      ...
      document
        ...
        .classList.toggle("sidebar-collapsed", this.isCollapsed);
      document
        .querySelector("#logoSystem")
        .classList.toggle("logoSystem", this.isCollapsed);
    },
    toggleSubMenu(menu) {
      if (menu === "products") {
