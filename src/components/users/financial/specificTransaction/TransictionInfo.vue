   ...
   <ValidationObserver ref="observer" v-slot="{ invalid }">
    <div class="financial-transaction">
      ...
      <div class="values-section">
        <div class="value">
          <label for="total-amount" class="label-payment">💰 Total Amount</label>
          <div class="amount-cont">
            <ValidationProvider name="total Amount " rules="required|numeric|min_value:1" v-slot="{ errors }">
              <input
                id="total-amount"
                class="amount-input"
                type="text"
                v-model="selectedTypeData.totalAmount"
                @input="updateSelectedTypeValues('totalAmount', $event.target.value)"
        ...
        <div class="value">
          <label for="remaining-value" class="label-payment">📉 Remaining Value</label>
          <div class="amount-cont">
            <input
              id="remaining-value"
              class="amount-input"
              ...
              @input="updateSelectedTypeValues('remainingValue', $event.target.value)"
        ...
        <div class="value">
          <label for="used-values" class="label-payment">🔄 Type Values</label>
          <select
            class="amount-input"
    ...
    <div class="payment-section">
      ...
      <div class="button-container">
        <button class="save-btn" :class="{ 'disabled-btn': invalid }" :disabled="invalid" @click="emitSaveEvent">💾 Save Transaction</button>
      </div>
