<template>
  ...
  export default {
    ...
    methods: {
      ...mapActions(useRandomTransactionsStore, ['deleteTransaction','hideTransaction']),
      ...
      async deleteSingleTransaction() {
        ...
        await this.deleteTransaction(this.transaction.id,this.transaction.type,this.profileId);
      },

      async hideSingleTransaction() {
        await this.hideTransaction(this.transaction.id,this.transaction.type,this.transaction,this.profileId);
      },
