<template>
  ...
  <div class="optionWraper">
    <OptionCard v-if="getRole == 'technical'">
      ...
      <template #optionTitle> Employee </template>
    ...
    <OptionCard :layout="getRole != 'technical' ? 'row' : 'column'">
      <template #iconLetter>
        <span class="letter_icon_option">
          {{ getRole == "technical" ? "T" : "M" }}</span
        >
      </template>
      ...
      <template #optionRouterLink>
        <router-link :to="generateRoute('RandomFinancial')">
          &rarr;
        </router-link>
      </template>
    </OptionCard>
    <OptionCard layout="row" v-if="getRole != 'technical'">
      ...
      <template #optionTitle> One Place </template>
      <template #optionLinkText> Like department </template>
      <template #optionRouterLink>
        <router-link :to="generateRoute('ListOfTransaction')">
          &rarr;
        </router-link>
      </template>
    </OptionCard>
    <OptionCard v-if="getRole == 'technical'">
      ...
      <template #optionTitle> expenses </template>
      <template #optionRouterLink>
        <router-link to="/"> &rarr; </router-link>
      </template>
    </OptionCard>
