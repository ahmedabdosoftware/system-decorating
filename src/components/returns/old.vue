  ...
  computed: {
    ...
    calculateDiscount() {
      ...
      if (this.purchaseInfo.discount_type === "percentage") {
        discountAmount =
          Number(total) * (Number(this.purchaseInfo.discount_value) / 100);
  ...
  methods: {
    ...
    calculateDiscountOnReturns(totalReturns) {
      ...
      if (this.purchaseInfo.discount_type === "percentage") {
        discountAmount =
          Number(totalReturns) *
          (Number(this.purchaseInfo.discount_value) / 100);
      } else if (this.purchaseInfo.discount_type === "fixed") {
        ...
        discountAmount =
          (Number(this.purchaseInfo.discount_value) * totalReturns) /
          totalPurchases;
      }
