<template>
  <div class="product-manager">
    ...
    <div class="formbold-input-flex">
      <div>
        <label for="ampuntOfIncrease" class="formbold-form-label aline-end">
    ...
    <div class="formbold-input-flex">
      <div></div>
      <div>
        <label for="editOfInstallation" class="formbold-form-label aline-end">
    ...
    <div class="formbold-mb-3 cont_add_del_upda">
      <button
        ...
        :disabled="
          !selectedProduct || (editOfInstallation <= 0 && amountOfIncrease == 0)
        "
