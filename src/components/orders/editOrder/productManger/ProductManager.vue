<template>
  <div class="product-manager">
    ...
    <div>
      <label for="addedOrders" class="formbold-form-label">
        Added Products</label
      >
      <select
    ...
    <div class="formbold-input-flex">
      <div>
        <ValidationProvider
          name="الكمية"
          :rules="`${
            addedOrders.length == 0 ? 'required|numeric|min_value:1' : ''
          }`"
          v-slot="{ errors }"
        >
    ...
    <div class="formbold-input-flex" v-if="pullFromBranch">
      <div>
        <ValidationProvider name="الكمية المتاحة" v-slot="{ errors }">
          <label for="quantityInBranch" class="formbold-form-label">
            Avilabel Quantity
          </label>
          <input
            type="number"
          ...
          <p v-if="aboutQuantityInBranchMessage" class="warning-message">
    ...
    >
      <div>
        <label for="lastPulledQuantity" class="formbold-form-label aline-end">
          كمية المسحوب
        </label>
        <input
          type="number"
      ...
      <div>
        <label for="lastPulledBranch" class="formbold-form-label aline-end">
          الفرع المسحوب منه
        </label>
        <input
          type="text"
    ...
    <div class="formbold-mb-3 cont_add_del_upda">
      ...
      <button @click.prevent="deleteProduct" class="deleteProduct-btn">
        حذف
      </button>
      <button @click.prevent="cancelChange" class="cancelChangeProduct-btn">
        الغاء
      </button>
    </div>
  </div>
