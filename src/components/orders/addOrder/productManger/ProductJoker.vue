<template>
  <div class="product-manager respo-form-order">
    ...
    <!-- خيارات إضافية -->
    <div
      class="choose-group_option"
      v-if="currentField.name || currentField.category"
    >
      ...
      <div v-if="currentField.willBeCalculated" class="choose-option">
        ...
        <label class="check-button">
          ...
          <input
            type="radio"
            value="installation"
            v-model="currentField.calculationType"
          />
        </label>
      </div>
      <div v-if="currentField.willBeCalculated" class="choose-option">
    ...
    <div
      v-if="
        currentField.name &&
        currentField.willBeCalculated &&
        currentField.calculationType == 'material'
      "
    >
      ...
      >
        <input
          v-model.number="currentField.purchaseCost"
    ...
    >
      <div>
        ...
        >
          <input
            class="formbold-form-input"
            v-model.number="currentField.valueDiscountOnBuy"
            placeholder="type here"
            type="number"
          />
          <span class="error">{{ errors[0] }}</span>
      ...
      <div>
        ...
        <select
          class="formbold-form-input"
          v-model.number="currentField.kindDiscount"
        >
    ...
    <div class="formbold-mb-3 cont_add_del_upda">
      ...
      <button @click="cancelEdit" class="cancelChangeProduct-btn">
        Cancel
      </button>
    </div>
  </div>
