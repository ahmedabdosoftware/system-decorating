<template>
  <div class="product-manager respo-form-order">
    <TransitionWrapper>
      <component :is="currentComponent" :addedOrders="addedOrders"  @added-orders-updated="handleAddedOrdersUpdate" @updateFields ="handleupdateFields"/> 
    </TransitionWrapper>
...
import ProductManager from "@/components/orders/addOrder/productManger/ProductManager.vue";
import ProductEditPrices from "@/components/orders/addOrder/productManger/ProductEditPrices.vue";
import ProductJoker from "@/components/orders/addOrder/productManger/ProductJoker.vue";
