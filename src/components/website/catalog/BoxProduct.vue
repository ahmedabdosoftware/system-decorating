<template>
  <div class="contPro">
    <div>
      ...
      <div>
        ...
        <div class="cont-price">
          <span v-if="oneProduct.offerPrice" class="inSaleBefore"
            >{{ oneProduct.priceMaterial }} : سعرال{{
              oneProduct.unitName.name
            }}</span
          >
          <span v-if="oneProduct.offerPrice" class="inSaleAfter"
            >{{ oneProduct.offerPrice }} : سعرال{{
              oneProduct.unitName.name
            }}</span
          >
          <span v-if="!oneProduct.offerPrice" class="outSale"
            >{{ oneProduct.priceMaterial }} : سعرال{{
              oneProduct.unitName.name
            }}</span
          >
          <span v-if="oneProduct.priceWithLabor && oneProduct.showLaborPrice"
    ...
    <div class="askForOrder">
      <button @click="DetailsPage(oneProduct.id)" class="ask">
        {{ lannguage.detailsProduct }}
      </button>
