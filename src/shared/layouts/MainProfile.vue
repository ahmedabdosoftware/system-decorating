  ...
  <div :class="{ 'dark-mode': getDarkMode }" id="profile-layout">
    <div v-if="userInfo" class="infoUser" id="infoUser">
        ...
        <div class="imge-profilee">
          <img
            ...
            :src="
              ...
              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR05q_vg5Ux_rPqNDBBeYLc1BHrG-qjaw7_tA&usqp=CAU'
            "
            alt="Profile Image"
          />
        </div>
      ...
      <div class="ddetails">
        ...
        <div class="parent">
          <div class="spechial_cont">
            Phone Number: <span class="spechial">{{ userInfo.number }}</span>
          </div>
          <div class="spechial_cont">
            Role: <span class="spechial">{{ userInfo.role }}</span>
          </div>
        </div>
      </div>
      <div class="trans">
        <router-link :to="generateRoute('')" exact> Orders </router-link>
        <router-link :to="generateRoute('financial')"> Financial </router-link>
        <router-link :to="generateRoute('projects')"> Projects </router-link>
        <DropdownMenuSetting />
      </div>
    </div>
    <router-view
      class="profile-content"
      :class="{ 'dark-mode': getDarkMode }"
    />
  </div>
</template>
